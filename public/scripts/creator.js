...
//    getCreatorScale(function(scale){
...
//}
//
//function getCreatorScale(callback) {
//  const wallImage = new Image();
//  wallImage.src = '../assets/wall_images/all.png'
//  wallImage.onload = function() {
//    scale = 0.95 * window.innerHeight / wallImage.height;
//    callback(scale);
//  }
//}
...
function init() {
  var s = new CanvasState(document.getElementById('route-canvas'));
